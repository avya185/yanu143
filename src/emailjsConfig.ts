...
export const CONTACT_EMAILJS_SERVICE_ID = metaEnv.VITE_EMAILJS_SERVICE_ID || 'service_v44ve1k';
export const CONTACT_EMAILJS_TEMPLATE_ID = metaEnv.VITE_EMAILJS_TEMPLATE_ID || 'template_duz1bnj';
export const CONTACT_EMAILJS_PUBLIC_KEY = metaEnv.VITE_EMAILJS_PUBLIC_KEY || 'oDZ-OdADS8J7knJIS';

export const CAREERS_EMAILJS_SERVICE_ID = metaEnv.VITE_CAREERS_EMAILJS_SERVICE_ID || 'service_zs67n1f';
export const CAREERS_EMAILJS_TEMPLATE_ID = metaEnv.VITE_CAREERS_EMAILJS_TEMPLATE_ID || 'template_hixw055';
export const CAREERS_EMAILJS_PUBLIC_KEY = metaEnv.VITE_CAREERS_EMAILJS_PUBLIC_KEY || 'ogSGvhwDbUR0oabqR';
=======
